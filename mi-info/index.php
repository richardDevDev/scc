        ...
        <main>
            ...
            <div class="contenid">
                ...
                <label>
                    ...
                    ?>
                        <?php echo "<b>" . "Matricula:  </b>" . $mostrar["username"] . "  |  " . "<b>  Nombre: </b>" . $mostrar["nombreuser"] ?>
                    <?php
                    }
                    ?>
                ...
                Genero: <Select name="cactual" id="cactual" value="s" required>
                    <?php
                    $result = mysqli_query($link, "SELECT * FROM usuarios WHERE username = '$user'");
                    while ($mostrar = mysqli_fetch_array($result)) {
                    ?>
                ...
                Licenciatura: <Select name="cactual" id="cactual" value="s" required>
                ...
                <select name="pregseg" id="">
                <option value="¿Como se llama mi mamá?">¿Como se llama mi mamá?</option>
                <option value="Primaria en la que estudie">Primaria en la que estudie</option>
                <option value="Nombre de mi primer mascota">Primaria en la que estudie</option>
                <option value="Nombre de mi primo(a) favorito">Primaria en la que estudie</option>
                </select><br>
                <input type="text" placeholder="Respuesta:" name="resp" value="">
                <p>es recomentable que escribas todo en minusculas :)</p><br><br>
                <input type="submit">
                </form>
                <br><br>
